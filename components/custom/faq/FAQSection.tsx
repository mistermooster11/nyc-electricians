      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About NYC Electrical Services
          </h2>
          <p className="faq__subtext">
            Clear answers about panel upgrades, EV charger installation, permits, emergency
            electrical service, and pricing for all five NYC boroughs.
          </p>
