  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          ...
          <p className="footer__desc">
            <strong>New York City Electricians</strong> — licensed, insured electrical contractors
            serving all five NYC boroughs. Panel upgrades, EV chargers, residential wiring, and
            24/7 emergency service. Upfront pricing. No hidden fees.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 New York City Electricians. All rights reserved.</p>
