          ...
          <div className="contact-section__details">
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                50 Saint Marks Place<br />New York,&nbsp;NY&nbsp;10003
              </p>
            ...
            <div className="contact-section__details-col">
              ...
              <p className="contact-detail__value">
                <Link href="tel:+16463409882">(646) 340-9882</Link>
              </p>

              <h5 className="contact-detail__label">Email</h5>
              <p className="contact-detail__value">
                <Link href="mailto:info@newyorkcityelectricianss.com">info@newyorkcityelectricianss.com</Link>
              </p>
            </div>
