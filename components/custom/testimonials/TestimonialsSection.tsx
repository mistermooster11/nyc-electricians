      ...
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          ...
          <p className="testimonials__subtext">
            Our clients rely on New York City Electricians for fast response, licensed professional
            service, and reliable solutions for panel upgrades, EV chargers, wiring, and 24/7
            emergency electrical service across all five NYC boroughs.
          </p>
        </div>
