    ...
    <section className="become-section" ref={sectionRef}>
      <div className="become-section__inner">
        <p className="become-section__intro">
          New York City Electricians is growing our team of licensed professionals across all five NYC boroughs.
          If you are a skilled electrician looking for consistent work with a reputable company,
