const DecorativeSVG = () => {
  return (
    <div className="opacity-10 md:opacity-100 absolute inset-10  md:inset-0 md:top-0 md:left-100 right-0 w-full h-full flex flex-row justify-end -z-10">
        <svg
      width="458"
      height="631"
      viewBox="0 0 458 631"
    ...
    >
      <rect x="0.5" y="0.5" width="267" height="110" stroke="#8CBCFF" />
      <rect x="0.5" y="174.5" width="285" height="110" stroke="#8CBCFF" />
      <rect x="183.5" y="174.5" width="274" height="110" fill="#8CBCFF" stroke="#8CBCFF" />
      <rect x="0.5" y="347.5" width="285" height="110" stroke="#8CBCFF" />
      <rect x="183.5" y="347.5" width="274" height="110" fill="#8CBCFF" stroke="#8CBCFF" />
      <rect x="183.5" y="520.5" width="274" height="110" fill="#8CBCFF" stroke="#8CBCFF" />
      ...
      <g mask="url(#mask0_1207_31853)">
        <path d="M112.5 110H0L185 274V173.832L112.5 110Z" stroke="#8CBCFF" />
      </g>
      ...
      <g mask="url(#mask1_1207_31853)">
        <path d="M266 -0.5V109L457 274V173.832L266 -0.5Z" stroke="#8CBCFF" />
      </g>
      ...
      <g mask="url(#mask2_1207_31853)">
        <path d="M112.5 284H0L185 448V347.832L112.5 284Z" stroke="#8CBCFF" />
      </g>
      ...
      <g mask="url(#mask3_1207_31853)">
        <path d="M385.5 284H273L458 448V347.832L385.5 284Z" stroke="#8CBCFF" />
      </g>
      ...
      <g mask="url(#mask4_1207_31853)">
        <path d="M385.5 457H273L458 621V520.832L385.5 457Z" stroke="#8CBCFF" />
      </g>
      ...
      <g mask="url(#mask5_1207_31853)">
        <path d="M115.5 457H0L185 632V521.832L115.5 457Z" stroke="#8CBCFF" />
      </g>
    </svg>
    </div>
  );
