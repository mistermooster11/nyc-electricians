    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Licensed Electrical Services Across All Five NYC Boroughs
        </h2>
        <p className="services__subtext">
          From panel upgrades and EV charger installations to residential wiring and 24/7
          emergency electrical service — licensed, insured, and ready to work.
        </p>
      </div>
